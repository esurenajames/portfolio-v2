        ...
        <div class="flex items-end gap-2 p-3">
          ...
          <div class="flex-1">
            <textarea
              ...
              rows="1"
              class="w-full resize-none px-2 bg-transparent border-none outline-none text-gray-900 placeholder-gray-400 text-sm md:text-base max-h-32 overflow-y-auto"
